...
class JsonableBehavior extends ModelBehavior {
	 ...
	 * @access public 
	 */
	function decodeItems(Model $Model, $arr) {
	...
	function _encode(Model $Model, $val) {
	 ...
	 * 2011-06-18 ms
	 */
	function _decode(Model $Model, $val) {
	 ...
	 */
	function _toParam(Model $Model, $val) {
		$res = array();
	...
	function _fromParam(Model $Model, $val) {
	 ...
	 */
	function _toList(Model $Model, $val) {
		return implode($this->settings[$Model->alias]['separator'], $val);
	}
	
	function _fromList(Model $Model, $val) {
		extract($this->settings[$Model->alias]);
	 ...
	 * @return boolean 
	 */
	function isEncoded(Model $Model, $str) {
